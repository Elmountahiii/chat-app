    ...
    (set, get) => ({
      ...
      initializeSocket: () => {
        ...
        socket.on(
          ...
          (data: { senderId: string; friendship: FriendShipRequest }) => {
            const { senderId, friendship } = data;
      ...
      fetchConversations: async () => {
        ...
        try {
          ...
          const response: HttpResponse<Conversation[]> =
      ...
      getAllFriendshipRequests: async () => {
        ...
        try {
          const rawResponse = await fetch(
            `${API_BASE_URL}/user/pending-requests`,
            {
              method: "GET",
              credentials: "include",
              headers: {
      ...
      acceptFriendshipRequest: async (FriendshipId: string) => {
        ...
        try {
          const rawResponse = await fetch(
            `${API_BASE_URL}/user/accept-request`,
            {
              method: "POST",
              credentials: "include",
              headers: {
      ...
      declineFriendshipRequest: async (FriendshipId: string) => {
        ...
        try {
          const rawResponse = await fetch(
            `${API_BASE_URL}/user/decline-request`,
            {
              method: "POST",
              credentials: "include",
              headers: {
