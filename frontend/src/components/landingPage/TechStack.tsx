    ...
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h3 className="text-3xl md:text-4xl font-bold text-light-text">
            Built With the Best
          </h3>
          <p className="text-dark-text mt-4 max-w-2xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {techStack.map((tech) => (
            <div
              ...
              <div className="absolute -inset-0.5 bg-gradient-to-r from-accent to-cyan-500 rounded-xl blur opacity-0 group-hover:opacity-75 transition duration-300"></div>

              <div className="relative bg-secondary p-8 rounded-xl h-full flex flex-col items-center text-center shadow-lg">
                <div className="text-dark-text w-16 h-16 mb-6 flex items-center justify-center">
                  {tech.logo}
                </div>
                <h4 className="text-xl font-bold text-light-text mb-3">
                  {tech.name}
                </h4>
                <p className="text-dark-text text-sm leading-relaxed flex-grow">
                  {tech.description}
                </p>
              </div>
            </div>
